...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-300 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-slate-50 text-slate-900 shadow hover:bg-slate-50/90",
        destructive: "bg-red-900 text-slate-50 shadow-sm hover:bg-red-900/90",
        outline: "border border-slate-800 bg-transparent shadow-sm hover:bg-slate-800 hover:text-slate-50",
